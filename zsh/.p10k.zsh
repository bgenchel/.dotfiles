# Generated by Powerlevel10k configuration wizard on 2019-11-26 at 14:35 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='$ $(date +%H:%M:%S) ❯❯'
  # Prompt symbol in command vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION='❮❮ $(date +%H:%M:%S) $'
